...
class keras_Layers:
    ...
    def category_encoding(
        self, num_tokens=None, output_mode=None, sparse=None, **kwargs
    ):
    ...
    def randomColorDegeneration(
        ...
        layer = ly.RandomColorDegeneration(
            factor=factor,
            value_range=value_range,
            data_format=data_format,
            seed=seed,
    ...
    def randomElasticTransform(
        ...
        **kwargs
        ...
        layer = ly.RandomElasticTransform(
            factor=factor,
            scale=scale,
            interpolation=interpolation,
            fill_mode=fill_mode,
    ...
    def solarization(
        self,
        addition_factor=None,
        threshold_factor=None,
        value_range=None,
        seed=None,
        **kwargs
    ):
        layer = ly.Solarization(
